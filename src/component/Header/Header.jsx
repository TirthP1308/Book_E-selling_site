...
import { AppBar, Button, List, ListItem, TextField, Typography } from "@material-ui/core";
import siteLogo from "../../assets/images/dummy-image.jpg";
            ...
            <div className="header-wrapper">
              <div className="logo-wrapper">
                <Link to="/" className="site-logo" title="logo">
                  ...
                  <Typography variant="h2">Book_E-selling_Site</Typography>
                </Link>
              </div>
              <div className="nav-wrapper">
                <div className="top-right-bar">
                  <List className="top-nav-bar" color="primary">
                    {!authContext.user.id && (
                    <>
                      <ListItem>
                  ...
                  {authContext.user.id && (
                      <List className="right">
                        <Button onClick={authContext.logOut} variant="outlined">
                          Log out
                        </Button>
                      </List>
                    )}
